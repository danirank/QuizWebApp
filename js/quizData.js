...
},
{
    ...
    questions: [
        {
            questionText: "Vilket instrument har 88 tangenter?",
            answers: [
                { text: "Piano", isCorrect: true },
                { text: "Gitarr", isCorrect: false },
                { text: "Fiol", isCorrect: false },
                { text: "Trummor", isCorrect: false }
            ]
        },
        {
            questionText: "Vilken musikgenre förknippas starkast med artisten Elvis Presley?",
            answers: [
                { text: "Jazz", isCorrect: false },
                { text: "Blues", isCorrect: false },
                { text: "Rock'n'Roll", isCorrect: true },
                { text: "Pop", isCorrect: false }
            ]
        },
        {
            questionText: "Vad betyder BPM inom musik?",
            answers: [
                { text: "Bass Per Measure", isCorrect: false },
                { text: "Beats Per Minute", isCorrect: true },
                { text: "Bars Per Melody", isCorrect: false },
                { text: "Beats Per Melody", isCorrect: false }
            ]
        },
        {
            questionText: "Vilket instrument tillhör träblåsfamiljen?",
            answers: [
                { text: "Trummor", isCorrect: false },
                { text: "Klarinett", isCorrect: true },
                { text: "Trumpet", isCorrect: false },
                { text: "Piano", isCorrect: false }
            ]
        },
        {
            questionText: "Hur många strängar har en standardgitarr?",
            answers: [
        ...
        {
            questionText: "Vilken ton är standardstämning för A (konsertton)?",
            answers: [
                { text: "440 Hz", isCorrect: true },
                { text: "432 Hz", isCorrect: false },
                { text: "400 Hz", isCorrect: false },
                { text: "450 Hz", isCorrect: false }
            ]
        },
        {
            questionText: "Vilket av följande är ett slagverksinstrument?",
            answers: [
                { text: "Fiol", isCorrect: false },
                { text: "Flöjt", isCorrect: false },
                { text: "Trummor", isCorrect: true },
                { text: "Cello", isCorrect: false }
            ]
        },
        {
            questionText: "Vad kallas en person som skriver musik?",
            answers: [
                { text: "Producent", isCorrect: false },
                { text: "Kompositör", isCorrect: true },
                { text: "Dirigent", isCorrect: false },
                { text: "DJ", isCorrect: false }
            ]
        }
    ]
},
